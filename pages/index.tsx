                ...
                <div className="content">
                    ...
                    <div className="container">
                        ...
                        <div>
                            ...
                            <p><a href="?x=information" className="ref">Информация</a> о рассчитываемой за календарный
                            ...
                            в Свердловской области.</p><p>Основным направлением деятельности Института является <a
                            href="?x=develop" className="ref">разработка</a> проектов законов и иных нормативных
                            правовых актов Свердловской области; большая часть принятых законов Свердловской области
                            ...
                            <p>Другим важным направлением деятельности является проводимая Экспертным советом Института
                                правовая <a href="?x=expert" className="ref">экспертиза </a>проектов нормативных
                            ...
                            <p>Новым направлением деятельности Института является инвентаризация полномочий субъектов
                                ...
                                информационно-правовой системы <a href="?x=region" className="ref">«Регион-Закон»</a>,
