...
export default class RegionalLegislationMonitoringPage extends Component<RegionalLegislationMonitoringPageState> {
    state: RegionalLegislationMonitoringPageState = {
    ...
    fetchYearsArrange = (): void => {
        fetch("/api/v1/regionalMonitoringYears")
    ...
    render(): React.ReactElement {
        ...
        return (
            <>
                <Layout title="Мониторинг законов Свердловской области"/>
                <Navbar/>
                <div className="content">
                    <Header/>
                    <MonitoringSubNav subNavId="monitoringSubNav" subNavItems={subNavItems}/>
                    <h1 className="text-center page__title">Мониторинг законов Свердловской области</h1>
